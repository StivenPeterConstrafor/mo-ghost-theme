...
|---|---|---|
| 09-15 | R2-SYNC-SPEC §3.1 — R2 works copy back on live: 565 works synced and checksum-verified (6,656 files; nine Book of Concord works were missing, page shards stale for most); `r2_works_sync.py --no-scans` archives everything but the scans; embed manifest refreshed (1,626 works) | mo-ghost-theme (ask-port-ui + docs branch) |
