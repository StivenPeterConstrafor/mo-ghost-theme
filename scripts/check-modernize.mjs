...
const CASES = [
  ...
  ["On the word or name of Theology, whence it takes its origin", "On the word or name of Theology, from where it takes its origin"],
  ["to be able to do evil: whence it also follows that", "to be able to do evil: hence it also follows that"],
  ["the flesh, whence it is written", "the flesh, hence it is written"],
