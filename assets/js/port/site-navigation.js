...
(function(){
 function bind(){
  ...
  if(!(has('/the-faith-received/authors/')&&has('/the-faith-received/bible/')&&has('/the-faith-received/topics/'))){const quick=document.createElement('nav');quick.className='fr-quick';quick.setAttribute('aria-label','Research');
  ...
  menu.innerHTML='<summary aria-label="Explore the library">Explore</summary><nav aria-label="Library sections"><a href="/the-faith-received/">Library</a><a href="/the-faith-received/authors/">Authors<small>Find an author’s works</small></a><a href="/the-faith-received/bible/">Scripture<small>Find biblical commentary</small></a><a href="/the-faith-received/topics/">Topics<small>Explore theological subjects</small></a><a href="/the-faith-received/compare/">Compare authors</a><a href="/the-faith-received/web/">Constellations</a><a href="/the-faith-received/pins/">Notebooks</a><a href="/the-faith-received/desk/">Writing desk</a></nav>';
