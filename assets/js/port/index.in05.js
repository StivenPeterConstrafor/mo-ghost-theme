  ...
  if(SEL_TRAD&&tg[SEL_TRAD]){
    ...
    {const _SH={"Latin Fathers":"pl","Greek Fathers":"gf","Eastern Fathers":"po","English Divines":"ed",
     ...
     if(_SH){
      ...
      +`<a class=scomp-l href="/the-faith-received/connections/"><span class=n>\u2727 Connections</span><span class=d>The entire library mapped by citation. Who reads whom, traced passage by passage.</span></a>`
      +'</div>';
      sw.appendChild(cb);}}
    ...
    {const cb=el("div","scomp");cb.innerHTML='<span class=sk>Reference</span>'
      +'<div class=scomp-row>'
      +'<a class=scomp-l href="/the-faith-received/dictionary/"><span class=n>Dictionary of Catholic Theology</span><span class=d>The great French theological dictionary (Vacant–Mangenot–Amann, 1899–1950): 1,916 articles in a dedicated lookup interface — search any headword.</span><span class=u>the dictionary door</span></a>'
