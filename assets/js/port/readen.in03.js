...
(async function(){
  ...
  if(!id){ $('#work').innerHTML='<p class="err">No work specified. <a href="/the-faith-received/all-works/?collection=all">Back to the library ›</a></p>'; return; }
  ...
  catch(e){ $('#work').innerHTML='<p class="err">Could not load this work ('+esc(e.message)+'). <a href="/the-faith-received/all-works/?collection=all">Back to the library ›</a></p>';
            $('#toc').innerHTML=''; }
})();
